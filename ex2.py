...
linha_a = transmission_line(name='L0A',
                            series_resistance=0.01008,
                            series_reactance=0.05040,
                            shunt_susceptance=0.05125)
linha_b = transmission_line(name='L0B',
                            series_resistance=0.00744,
                            series_reactance=0.03720,
                            shunt_susceptance=0.03875)
linha_c = transmission_line(name='L0C',
                            series_resistance=0.01272,
                            series_reactance=0.06360,
                            shunt_susceptance=0.06375)

Line = [linha_a, linha_b, linha_c]
# Barramentos
Sbase = 100  # MVA
Bus = [
    bus_v_theta(name="B01",
                ...
                voltage_angle=0.0),
    bus_p_q(name="B02",
            active_power=170/Sbase,
            reactive_power=105.35/Sbase),
    bus_p_q(name="B03",
            active_power=200/Sbase,
            reactive_power=123.94/Sbase),
    bus_p_v(name="B04",
            active_power=-150/Sbase,
            voltage_amplitude=1.02)
]
