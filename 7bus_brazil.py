...
linha_01 = transmission_line(name='L01',
                             series_resistance=0.0030,
                             series_reactance=0.0380,
                             shunt_susceptance=0.0000)
linha_02 = transmission_line(name='L02',
                             series_resistance=0.0190,
                             series_reactance=0.2450,
                             shunt_susceptance=0.0000)
linha_03 = transmission_line(name='L03',
                             series_resistance=0.0050,
                             series_reactance=0.0760,
                             shunt_susceptance=0.0000)
linha_04 = transmission_line(name='L04',
                             series_resistance=0.0150,
                             series_reactance=0.2250,
                             shunt_susceptance=0.0000)
linha_05 = transmission_line(name='L05',
                             series_resistance=0.0029,
                             series_reactance=0.0734,
                             shunt_susceptance=0.0000)
linha_06 = transmission_line(name='L06',
                             series_resistance=0.0040,
                             series_reactance=0.0570,
                             shunt_susceptance=0.0000)


# trafo = generalized_model(transform_ratio=1, phase_shift_angle=0, #series_resistance=0, series_reactance, shunt_susceptance)

Line = [linha_01, linha_02, linha_03, linha_04, linha_05, linha_06]
# Barramentos
...
# Ramos
Branch = [
    branch_data(from_bus="B01_FOZ_AREIA",
                to_bus="B03_S.SEGREDO",
                model_data=linha_01),
    branch_data(from_bus="B01_FOZ_AREIA",
                to_bus="B05_IVAIPORA",
                model_data=linha_02),
    branch_data(from_bus="B02_S.SANTIAGO",
                to_bus="B03_S.SEGREDO",
                model_data=linha_03),
    branch_data(from_bus="B02_S.SANTIAGO",
                to_bus="B05_IVAIPORA",
                model_data=linha_04),
    branch_data(from_bus="B04_ITAIPU",
                to_bus="B06_IVAIPORA",
                model_data=linha_05),
    branch_data(from_bus="B06_IVAIPORA",
                to_bus="B07_EQUIVALENTE",
                model_data=linha_06),
]
...
# Bases in p.u
Sbase = 1e3
df_bus.loc[:, ["$P$", "$Q$"]] = df_bus.loc[:, ["$P$", "$Q$"]]/Sbase
